  <%@ page language="java" contentType="text/html; charset=utf-8"%>
    ...
    <link rel="stylesheet" href="<%=WEBPACK_PATH%>/assets-dist/css/bundle.css">
    </head>
    <body>
    ...
    <script src="<%=WEBPACK_PATH%>/assets-dist/<%=PROJECT_NAME%>/common.js"></script>
    <script src="<%=WEBPACK_PATH%>/assets-dist/<%=PROJECT_NAME%>/app.js"></script>
