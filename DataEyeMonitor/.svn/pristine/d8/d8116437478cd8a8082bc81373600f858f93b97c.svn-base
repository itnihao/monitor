...
public class AlarmBasicRule {
	...
	/**
	 * @param shieldTime the shieldTime to set
	 */
	...
	/**
	 * @param alarmSectionType
	 *            the alarmSectionType to set
	 */
	...
	/**
	 * @param alarmTypes the alarmTypes to set
	 */
