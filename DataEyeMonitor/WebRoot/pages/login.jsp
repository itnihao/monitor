...
.input-group-addon.verifyCode {
  background-image: url("data:image/png;base64,");
}
.get-verifyCode {
  ...
  $(function(){
    ...
    $(".get-verifyCode").click(function() {
      ...
      $.ajax({
        ...
        data: {uid: $('input[name="email"]').val(), app: 'omp'},
        dataType : 'jsonp',
        jsonp:"jsoncallback",
    ...
    function login(){
      ...
      $.ajax({
        type: "post",
        url:"../login.do",
        data:$('#formlogin').serialize() + "&app=omp",
        async: true,
        success: function(data) {
        ...
        error: function(data) {
          $(".login-error").show();
          $(".login-error").html(JSON.parse(data.responseText).content || 'undefined');
        }
      });
    }
  })
